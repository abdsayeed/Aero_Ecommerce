...
CREATE INDEX "idx_variants_size" ON "product_variants" USING btree ("size_id");--> statement-breakpoint
CREATE INDEX "idx_products_brand_published" ON "products" USING btree ("brand_id","is_published");--> statement-breakpoint
CREATE INDEX "idx_products_category_published" ON "products" USING btree ("category_id","is_published");--> statement-breakpoint
CREATE INDEX "idx_products_gender_published" ON "products" USING btree ("gender_id","is_published");--> statement-breakpoint
CREATE INDEX "idx_products_created_at" ON "products" USING btree ("created_at");--> statement-breakpoint
CREATE UNIQUE INDEX "reviews_product_user_unique" ON "reviews" USING btree ("product_id","user_id");